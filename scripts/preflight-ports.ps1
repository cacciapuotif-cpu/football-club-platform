# ============================================================
# FOOTBALL CLUB PLATFORM - Preflight Port Check (PowerShell)
# ============================================================
...
if (-not $projectName) { $projectName = "football_club_platform" }

# Porte da verificare (incluso MinIO)
$ports = @(
...
"============================================================" | Out-File $logPath
"FOOTBALL CLUB PLATFORM - Preflight Port Check" | Out-File $logPath -Append
